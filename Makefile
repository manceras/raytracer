...
CORE = core/vec3.cpp core/ray.cpp core/viewport.cpp core/rgb_color.cpp core/obj_parser.cpp core/vertex.cpp core/config_parser.cpp core/trace.cpp core/aabb.cpp
